...
public class SocialCredentialRefreshService {
    ...
    private final ApiCredentialResolver credentialResolver;
    ...
    public ResolvedApiCredential resolveValid(String providerName) {
        ...
        synchronized (providerLocks.computeIfAbsent(provider, ignored -> new Object())) {
            ResolvedApiCredential credential = credentialResolver.resolveActiveIncludingExpired(
            ...
            refresh(credential);
            return credentialResolver.resolveActive(CredentialType.SOCIAL_PLATFORM, provider);
        }
    }
    ...
    public int refreshExpiringCredentials() {
        ...
        for (ApiCredential credential : credentials) {
            try {
                ResolvedApiCredential resolved = credentialResolver.resolveActiveIncludingExpired(
                        CredentialType.SOCIAL_PLATFORM,
